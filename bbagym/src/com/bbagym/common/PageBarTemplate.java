...
public class PageBarTemplate {
	...
	public static String pageBar(String url,String url2,int totalData,int cPage,int numPerpage) {
		String pageBar="";
		int pageBarSize=5;
		int totalPage = (int) Math.ceil((double)totalData/numPerpage);
		int pageNo=((cPage-1)/pageBarSize)*pageBarSize+1;
		...
		if(pageNo==1) {
			...
			pageBar +="<li class='page-item'><a class='page-link' href='"+url+"?cPage="+(pageNo-1)+url2+"'>[Previous]</a></li>";
		}
		...
		while(!(pageNo>pageEnd||pageNo>totalPage)) {
			if(pageNo==cPage) {
				...
				pageBar += "<li class='page-item'><a class='page-link'  href='"+url+"?cPage="+pageNo+url2+"'>"+pageNo+"</a></li>";
			}
			pageNo++;
		}
		...
		if(pageNo>totalPage) {
			...
			pageBar +="<li class='page-item'><a class='page-link'  href='"+url+"?cPage="+pageNo+url2+"'>[Next]</a></li>";
		}
