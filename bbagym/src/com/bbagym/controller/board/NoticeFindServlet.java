...
public class NoticeFindServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Notice> list = new NoticeService().searchNotice(searchType, searchKeyword, cPage, numPerPage);
		
		String pageBar = "";
		pageBar+= "<ul class='pagination justify-content-center'>";
		
		int totalData = new NoticeService().selectCount(searchType, searchKeyword);
