        ...
        <form action="<%=request.getContextPath() %>/trainer/enrollend1" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="c-name" placeholder="센터명을 입력하세요" name="c-name">
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="tel" class="form-control" name="c-phone">
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="hompage">
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control-file" id="photo-main" aria-describedby="fileHelp" >
            ...
            <div class="form-group div-photo">
              ...
              <div class="div-here">
                <input type="file" class="form-control-file" id="photo-0" aria-describedby="fileHelp">
