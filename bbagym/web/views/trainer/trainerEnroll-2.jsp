      ...
      <div class="row">
        <div class="col-lg-8 col-md-9 col-sm-12">
          <div class="form-group">
            ...
            <textarea class="form-control" name="" rows="3" placeholder="트레이너님에 대한 소개를 작성하여 트레이너님을 어필해주세요."></textarea>
          </div>
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 info-footer">
          <div class="info-footer-inner">
            <a href="<%=request.getContextPath()%>/views/trainner/trainnerEnroll-1.jsp"><button type="button" class="btn btn-secondary">이전</button></a>
            &nbsp;&nbsp;&nbsp;
